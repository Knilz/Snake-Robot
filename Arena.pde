class Arena {
  ...
  public Arena(Capture cam, int pBreite, int pHoehe, float aBreite, float aHoehe) {
    ...
    colBack = color(170, 50, 15);   //rot
    colFood = color(18, 81, 150); //blau
  }
  ...
  private void updatePix() {
    ...
    float allDif = 90;              //erlaubter Abstand den die Farben haben dürfen um als gesuchtes Objekt erkannt zu werden
